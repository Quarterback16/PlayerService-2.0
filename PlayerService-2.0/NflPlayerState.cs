namespace PlayerService_2._0
{
    public class NflPlayerState
    {
        ...
        public string ProjW04 { get; set; }
        public string ProjW05 { get; set; }
        public string ProjW06 { get; set; }
        public string ProjW07 { get; set; }
        public string ProjW08 { get; set; }
        public string ProjW09 { get; set; }
        public string ProjW10 { get; set; }
        public string ProjW11 { get; set; }
        public string ProjW12 { get; set; }
        public string ProjW13 { get; set; }
        public string ProjW14 { get; set; }
        public string ProjW15 { get; set; }
        public string ProjW16 { get; set; }
        public string ProjW17 { get; set; }
        public string ProjW18 { get; set; }
        public string ProjQ1 { get; set; }
